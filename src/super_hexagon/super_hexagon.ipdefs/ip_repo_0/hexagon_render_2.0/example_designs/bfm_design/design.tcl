proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins hexagon_render_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins hexagon_render_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins hexagon_render_0/S00_AXI_ARESETN]
...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI] [get_bd_intf_pins hexagon_render_0/M00_AXI]
	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/S_AXI_ACLK] [get_bd_pins hexagon_render_0/M00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/S_AXI_ARESETN] [get_bd_pins hexagon_render_0/M00_AXI_ARESETN]
	connect_bd_net -net init_axi_txn_00 [get_bd_ports M00_AXI_INIT_AXI_TXN] [get_bd_pins hexagon_render_0/M00_AXI_INIT_AXI_TXN]
	connect_bd_net -net error_00 [get_bd_ports M00_AXI_ERROR] [get_bd_pins hexagon_render_0/M00_AXI_ERROR]
	connect_bd_net -net txn_done_00 [get_bd_ports M00_AXI_TXN_DONE] [get_bd_pins hexagon_render_0/M00_AXI_TXN_DONE]
	...
	set offset_file "${bd_path}/hexagon_render_v2_0_tb_include.vh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef hexagon_render_v2_0_tb_include_vh_"
	puts $fp "`define hexagon_render_v2_0_tb_include_vh_\n"
...
set test_bench_file ${ip_path}/example_designs/bfm_design/hexagon_render_v2_0_tb.v
...
for { set i 1 } { 1 } { incr i } {
	set design_name "hexagon_render_v2_0_bfm_${i}"
...
remove_files -quiet -fileset sim_1 hexagon_render_v2_0_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top hexagon_render_v2_0_tb [get_filesets sim_1]
